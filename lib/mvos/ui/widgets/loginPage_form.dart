    ...
    return Padding(
      ...
      child: Form(
        ...
        child: SingleChildScrollView(
          child: Center(
            child: Consumer<SavedUserO>(

              builder: (context, savedUserO, c) {
                return Column(
                  children: <Widget>[
                    SizedBox(height: 40,),
                    Visibility(
                      visible: savedUserO!=null?true:false,
                      child: InkWell(
                          onTap: (){},
                    ...
                    Consumer<LoginA>(
                      builder: (context, o, _) => savedUserO!=null?Container():Row(
...
//                        call o.createAccount(name:_controller.name,....
                          ...
                          Checkbox(
                            value: o.rememberMe, onChanged: (bool value) {setState(() {
                              o.rememberMe=!o.rememberMe;
                          });},
